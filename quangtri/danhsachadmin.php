...
$sql = "SELECT * FROM admin ORDER BY id ASC LIMIT $perRow,$rowsPerPage";
$query = mysqli_query($conn, $sql);
$totalRow=mysqli_num_rows(mysqli_query($conn,"SELECT * FROM admin"));
$totalPages = ceil($totalRow/$rowsPerPage);
$listPage="";
for($i = 1; $i<=$totalPages; $i++){
  if($page==$i){
    $listPage.='<li class="page-item active"><a class="page-link" href="./danhsachadmin.php?page='.$i.'">'.$i.'</a></li>';
  }
  else{
    $listPage.='<li class="page-item"><a class="page-link" href="./danhsachadmin.php?page='.$i.'">'.$i.'</a></li>';
  }
}
...
<div class="danhsachthucdon">
    ...
    <a href="./themtkadmin.php" class="themthucdonlink"><span>Thêm Admin</span></a>
    <table class="table table-striped">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td><?php $name = $rows["adname"]; echo $rows["adname"]; ?></td>
        </tr>
      <?php } ?>
      </tbody>
    </table>
